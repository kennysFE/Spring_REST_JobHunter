...
public class JobService {
    ...
    public ResCreateJobDTO handleCreateJob(Job j) {
        // check skills
        /*
         * if user enter id not found => don't save skill for that job
         * if id valid => check and get skill by id => setSkill for that job
         */
        if (j.getSkills() != null) {
            List<Long> skillIds = j.getSkills().stream().map(x -> x.getId()).collect(Collectors.toList());
        ...
        // convert response skill => setSkill get only name skill
    ...
    public ResUpdateJobDTO handleUpdateJob(Job j, Job jobInDB) {
        // check skills
        /*
         * if user enter id not found => don't save skill for that job => set
         * if id valid => check and get skill by id => setSkill for that job
         */
